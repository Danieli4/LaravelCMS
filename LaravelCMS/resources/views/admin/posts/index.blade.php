                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                <a href="{{route("admin.posts.edit", $post->id)}}" class="text-blue-900 hover:text-red-900">Редактировать</a>
                                <form action="{{route("admin.posts.destroy", $post->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button button type="submit" class="text-red-600 hover:text-red-900">Удалить</button>
                                </form>
